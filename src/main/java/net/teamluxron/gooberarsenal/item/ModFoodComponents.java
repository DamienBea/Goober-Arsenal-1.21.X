...
public class ModFoodComponents {
    ...
    public static final FoodComponent CONTRABAND_CASE = new FoodComponent.Builder().nutrition(6).saturationModifier(2f).alwaysEdible()
    ...
    public static final FoodComponent SANDVICH = new FoodComponent.Builder().nutrition(8).saturationModifier(10f).alwaysEdible()
            .statusEffect(new StatusEffectInstance(StatusEffects.INSTANT_HEALTH, 20, 1), 1)
            .build();

    public static final FoodComponent CHOCOLATE_CHIP_PANCAKES = new FoodComponent.Builder().nutrition(6).saturationModifier(4f)
            .build();
